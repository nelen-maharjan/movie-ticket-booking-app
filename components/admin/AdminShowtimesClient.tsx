  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    startTransition(async () => {
      try {
        ...
        if (!endTime) {
          throw new Error("Select movie and start time first");
        }
        ...
        await createShowtime({
          ...
          premiumMultiplier: Number(form.premiumMultiplier),
          vipMultiplier: Number(form.vipMultiplier),
          reclineMultiplier: Number(form.reclineMultiplier),
        });
              ...
              >
                ...
                <td className="p-4 hidden lg:table-cell">
                  ...
                  <div className="flex items-center gap-1 text-xs text-muted-foreground">
                    ...
                    Demand: {(st.demandScore * 100).toFixed(0)}%
                  </div>
                </td>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="flex h-10 w-full rounded-md border border-border bg-secondary/50 px-3 text-sm"
                  required
                >
